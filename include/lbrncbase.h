 ...
 * Routines
 */
extern long rnc_plen (void *packed);
extern long rnc_ulen (void *packed);
#ifndef COMPRESSOR
extern long rnc_unpack (const void *packed, void *unpacked, const unsigned int flags);
#else
extern long rnc_unpack (const void *packed, void *unpacked, const unsigned int flags, long *leeway);
#endif

extern char *rnc_error (long errcode);
extern long rnc_crc (const void *data, unsigned long len);
